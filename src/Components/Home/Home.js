				...
				filteredCategories.map(category=>{
					return(
						<fieldset key={category} className="b m-2 pt-0 ">
							<legend className="b w-25 d-flex text-left pl-1 ml-3 " onClick={()=>props.onPageChange('display-category',category)}><p className="ml-5 mb-0">{category.toUpperCase()}</p></legend>
